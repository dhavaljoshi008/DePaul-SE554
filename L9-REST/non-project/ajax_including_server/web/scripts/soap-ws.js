...
$(document).ready(function() {
    var productServiceUrl = 'services/BootServicePort'; // Preferably write this out from server side

    var soapMessage =
        '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.ipd.depaul.edu/">\
                <soapenv:Header/>\
                <soapenv:Body>\
                <ws:getBootStyles/>\
                </soapenv:Body>\
